...
do
  ...
  vim.keymap.set('n', '<leader>cd', function() vim.diagnostic.open_float() end, { desc = 'Show [D]iagnostic' })
...
do
  ...
  --
  -- vim.keymap.set('n', '<leader>e', function() require('mini.files').open(vim.api.nvim_buf_get_name(0), true) end, { desc = 'Open file [E]xplorer' })
